 ...
 *  - 第三方脚本/接口（Giscus、AdSense、Umami、Cloudflare beacon、Vercel vitals）：不拦截，交给浏览器
 *
...
self.addEventListener('fetch', (event) => {
  ...
  if (url.origin !== self.location.origin) {
    ...
    // （Giscus、AdSense、Umami、Cloudflare beacon、vitals.vercel-insights.com），避免缓存广告 / 评论 / 统计响应。
  ...
  // Vercel 注入的运行时路径（Speed Insights / Analytics 脚本与上报）：走网络，不缓存。
