    ...
    <>
      <div>
        <div className="pt-6 pb-6">
          <h1 className="font-heading text-3xl leading-9 font-semibold tracking-normal text-gray-900 sm:text-4xl sm:leading-10 md:text-5xl md:leading-14 dark:text-gray-100">
            {title}
          </h1>
        </div>
