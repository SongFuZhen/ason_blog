...
我，一个干了十年前端的人，从今年5月份开始，折腾 Vibe Coding 直到今天，一毛钱没充过。

全部投入就 14 块，还是买域名花的，一杯奶茶钱。

看过我之前帖子的人可能也知道，我5月份开始申请到了 MiMo Pro 套餐，免费了一个月，从此踏入了 Vibe Coding 卷王模式。
...
毕竟，都说全栈，但作为前端，除了网页端审美，对客户友好一些之外，剩下来的东西可都是很耗费时间的，尤其是运维和SEO等后续一系列重复性工作。
...
Vercel 的 Hobby 计划对个人免费，连上 GitHub，push 一次自动构建上线，域名、HTTPS、全球 CDN 全给你安排得明明白白。

数据库用的 Neon，免费档的 Postgres。在 Vercel Storage 点一下就接进来，环境变量自动注入，省掉自己开库、配连接串的一堆破事。个人项目那点量，免费额度绰绰有余。

有个坑得提一嘴：代码里别把数据库连接一直攥着不放，用完该还就还，不然额度掉得跟流水一样。我有一次快到月底 Compute 超了 100CU-hrs，好在 Neon 次月自动重置，没整出啥幺蛾子。剩下的 Storage 0.5GB，Network transfer 5GB，正常小站根本摸不到这个边，放心用。

前端出身这时候就占便宜了：Node 熟，Next.js 一套代码把页面和 API 全写了，前后端不用切技术栈，一个人就是一个全栈。

### 二、Next.js 直接上 16，别在 14 上耗着
...
站做起来之后的事，比如 SEO、Google AdSense 这些变现路子，展开又是一篇的量，这回先不聊。坑我已经踩了一部分，下篇单独拎出来讲，感兴趣的可以先蹲着。

\#VibeCoding #前端开发 #Nextjs #独立开发 #AI工具 #免费资源 #全栈
