...
<img
  src="/static/blog/vercel-deployment-storage.png"
  alt="Vercel 面板里的 Deployment Storage 曲线：8 月 17 日起从 0 缓慢爬升，9 月 6 日到 11GB 出头并维持一周，之后掉回 0"
/>
...
站点接了 Service Worker 做离线阅读（见 [《把网站装进主屏幕：PWA 的实践之路》](/blog/ai/pwa-practice)），缓存配额同样有限，跨图床返回的 opaque 响应尤其占地方——浏览器按响应可能的最大体积计入配额，几条大图就吃掉不少；
